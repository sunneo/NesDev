...
{
    public partial class CodeDisassemblyForm : DockContent
    {
        ...
        {
            WindowsUser32.SendMessage(control.Handle, WM_SETREDRAW, IntPtr.Zero, IntPtr.Zero);
            OldEventMask = (IntPtr)WindowsUser32.SendMessage(control.Handle, EM_SETEVENTMASK, IntPtr.Zero, IntPtr.Zero);
        }

        private void ResumeRedraw(Control control)
        {
            WindowsUser32.SendMessage(control.Handle, WM_SETREDRAW, (IntPtr)1, IntPtr.Zero);
            WindowsUser32.SendMessage(control.Handle, EM_SETEVENTMASK, IntPtr.Zero, OldEventMask);
        }
