...
namespace NesCore.Storage
{
    class CartridgeMapMmc1 : CartridgeMap
    {
        ...
        public override byte this[ushort address]
        {
            ...
            set
            {
                if (address < 0x2000)
                {
                    ...
                    if(CharacterBankSwitch!=null) CharacterBankSwitch.Invoke((ushort)characterBankOffsets[bank], 0x1000);
                }
                else if (address >= 0x8000)
                {
        ...
        private void WriteCharacterBank0(byte value)
        {
            ...
            if(CharacterBankSwitch!=null) CharacterBankSwitch.Invoke(0x0000, 0x1000);
        ...
        private void WriteCharacterBank1(byte value)
        {
            ...
            if(CharacterBankSwitch!=null) CharacterBankSwitch.Invoke(0x1000, 0x1000);
        ...
        private void WriteProgramBank(byte value)
        {
            ...
            if(ProgramBankSwitch!=null) ProgramBankSwitch.Invoke(0xE000, 0x2000);
