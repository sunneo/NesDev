    ...
    public class RicohRP2C0X
    {
        ...
        public byte Control
        {
            ...
            set
            {
                ...
                if(SpriteSizeChanged!=null) SpriteSizeChanged.Invoke(spriteSize);
        ...
        public void Step()
        {
            ...
            if (renderingEnabled)
            {
                ...
                if (renderLine && fetchCycle)
                {
                    ...
                    if(EvaluatingBackgroundData!=null) EvaluatingBackgroundData.Invoke();
        ...
        private void NmiChange(int adjustment = 0)
        {
            ...
            if (nmi && !nmiPrevious)
            {
                ...
                //if(TriggerNonMaskableInterupt!=null) TriggerNonMaskableInterupt.Invoke();
                nmiDelay = 15;
            }
            nmiPrevious = nmi;
        }
        ...
        {
            if(EvaluatingSpriteData!=null) EvaluatingSpriteData.Invoke();
