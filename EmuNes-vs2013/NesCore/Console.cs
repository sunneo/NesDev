...
namespace NesCore
{
    public class Console
    {
        ...
        public void Reset()
        {
            ...
            if(Cartridge!=null) Cartridge.Map.Reset();
        }
        ...
        public ulong Step()
        {
            ...
            {
                Video.Step();
                if(Cartridge!=null) Cartridge.Map.StepVideo(Video.ScanLine, Video.Cycle, Video.ShowBackground, Video.ShowSprites);
	        }
        ...
        /// <returns></returns>
        public ulong Run(double deltaTime, BackgroundWorker worker=null)
        {
