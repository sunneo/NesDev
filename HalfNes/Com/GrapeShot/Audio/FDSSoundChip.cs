...
{
    public class FDSSoundChip : ExpansionSoundChip
    { //emulates the wavetable channel in the FDS 2C33 sound chip
        ...
        int waveAddr, waveOut,
                waveAccum; //16 bits
        bool waveWriteEnable; //holds channel at last output value when on and
        //allows access to wavetable RAM. does NOT stop wave unit. 

        //envelopes
        bool volEnvDirection, volEnvDisable, modEnvDirection, modEnvDisable;
        ...
        bool BothEnvDisable, haltWaveAndReset;
