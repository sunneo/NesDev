...
{
    public class MMC5SoundChip:ExpansionSoundChip
    {//really quickly hacked together. Need better interfaces for this kind of thing.
        ...
        public void write(int register, int data)
        {
            switch (register)
            {
                ...
                case 0x10:
                    ...
                    if (pcmIRQen || pcmMode)
                    {
                        Console.Error.WriteLine("Implement the MMC5 PCM IRQ, something's using it!");
                    }
                    break;
                case 0x11:
                    if (!pcmMode)
        ...
        private void setvolumes()
        {
            ...
            //Console.Error.WriteLine("setvolumes " + volume[1]);
        }
        ...
        {
            //Console.Error.WriteLine("frame ctr clock " + framectr);
